...
# Секретный ключ
SECRET_KEY = 'nv=_bi35g($0u0)kas%&(nndfgjhT^RC%fc-@_a00l+vej(t7vm9)_kw'
...
WSGI_APPLICATION = 'diagram.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'diagramsuperuser@gmail.com'
...
HOST_URL = f'http://0.0.0.0:8002/'

BAD_PASSWORD_MAX_COUNT = 5
BAD_PASSWORD_TIMEOUT = 60*60
